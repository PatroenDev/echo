...
if __name__ == '__main__':
    # How to use
    if len(sys.argv) < 2:
        sys.exit('Usage: python' + ['2','3'][PY3X] + ' RVR.py file')

    # About this program
    print(__doc__ + 'Decompile ' + sys.argv[1] + ' will begin. Please wait...')
    ...
    f.truncate(0)
    sys.stdout.write('Decompiling code objects...Selesai\n')
    anim_text('Menyimpan kode ' + o + '...')
    open(o, 'w').write(c)
    sleep(0.8)
    sys.stdout.write('Menyimpan hasil ke ' + o + '...selesai\n')
    sleep(0.3)
    print('\x1b[?25h\n' + c + '\n')
